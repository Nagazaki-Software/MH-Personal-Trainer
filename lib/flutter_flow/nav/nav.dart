      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: AvaliacaoOnlineLiveWidget.routeName,
              path: AvaliacaoOnlineLiveWidget.routePath,
              builder: (context, params) => AvaliacaoOnlineLiveWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: AvaliacaoOnlineAlunoWidget.routeName,
              path: AvaliacaoOnlineAlunoWidget.routePath,
              builder: (context, params) => AvaliacaoOnlineAlunoWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: GerenciarAlunosNovoWidget.routeName,
              path: GerenciarAlunosNovoWidget.routePath,
              builder: (context, params) => GerenciarAlunosNovoWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: ProgressoDoAlunoPERSONALWidget.routeName,
              path: ProgressoDoAlunoPERSONALWidget.routePath,
              builder: (context, params) => ProgressoDoAlunoPERSONALWidget(
                user: params.getParam(
                  'user',
                  ParamType.DocumentReference,
                  isList: false,
            ...
            FFRoute(
              name: TreinosForClienteCopyCopyWidget.routeName,
              path: TreinosForClienteCopyCopyWidget.routePath,
              builder: (context, params) => TreinosForClienteCopyCopyWidget(
                cliente: params.getParam(
                  'cliente',
                  ParamType.DocumentReference,
                  isList: false,
            ...
            FFRoute(
              name: TreinosForClienteCopyCopyCopyWidget.routeName,
              path: TreinosForClienteCopyCopyCopyWidget.routePath,
              builder: (context, params) => TreinosForClienteCopyCopyCopyWidget(
                cliente: params.getParam(
                  'cliente',
                  ParamType.DocumentReference,
                  isList: false,
          ...
          final child = appStateNotifier.loading
              ? isWeb
                  ...
                  : Container(
                      ...
                      child: Image.asset(
                        'assets/images/fundo_gradiente_leve-removebg-preview.png',
                        fit: BoxFit.contain,
                      ),
                    )
