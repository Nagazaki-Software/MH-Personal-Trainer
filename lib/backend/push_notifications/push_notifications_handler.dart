...
final parametersBuilderMap =
  ...
  'avaliacaoOnlineLive': ParameterData.none(),
  ...
  'avaliacaoOnlineAluno': ParameterData.none(),
  ...
  'gerenciarAlunosNovo': ParameterData.none(),
  ...
  'progressoDoAlunoPERSONAL': (data) async => ParameterData(
        allParams: {
          'user': getParameter<DocumentReference>(data, 'user'),
        },
      ),
  ...
  'treinosForClienteCopyCopy': (data) async => ParameterData(
        allParams: {
          'cliente': getParameter<DocumentReference>(data, 'cliente'),
        },
      ),
  ...
  'treinosForClienteCopyCopyCopy': (data) async => ParameterData(
        allParams: {
          'cliente': getParameter<DocumentReference>(data, 'cliente'),
