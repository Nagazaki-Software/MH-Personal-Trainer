...
import 'treinos_for_cliente_copy_copy_model.dart';
export 'treinos_for_cliente_copy_copy_model.dart';

class TreinosForClienteCopyCopyWidget extends StatefulWidget {
  const TreinosForClienteCopyCopyWidget({
    super.key,
  ...
  static String routeName = 'treinosForClienteCopyCopy';
  static String routePath = 'treinosForClienteCopyCopy';

  @override
  State<TreinosForClienteCopyCopyWidget> createState() =>
      _TreinosForClienteCopyCopyWidgetState();
}

class _TreinosForClienteCopyCopyWidgetState
    extends State<TreinosForClienteCopyCopyWidget>
    with TickerProviderStateMixin {
  late TreinosForClienteCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TreinosForClienteCopyCopyModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final treinosForClienteCopyCopyUsersRecord = snapshot.data!;

        return Title(
            title: 'treinosForClienteCopyCopy',
                  ...
                  desktop: false,
                    ...
                    ? AppBar(
                        ...
                        leading: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'TREINOS_FOR_CLIENTE_COPY_COPY_arrow_back');
                                ...
                                children: [
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: Image.network(
                                                  valueOrDefault<String>(
                                                    treinosForClienteCopyCopyUsersRecord
                                                        .photoUrl,
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Container(
                                                      width: () {
                                                        if (treinosForClienteCopyCopyUsersRecord
                                                                .tipoDeGerenciamento ==
                                                            'Apenas avaliações físicas') {
                                                          return 220.0;
                                                        } else if (treinosForClienteCopyCopyUsersRecord
                                                                .tipoDeGerenciamento ==
                                                            'Presencial') {
                                                          return 130.0;
                                                        } else {
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'TREINOS_FOR_CLIENTE_COPY_COPY_Container_');
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'TREINOS_FOR_CLIENTE_COPY_COPY_Column_2no');
                                                      if (Navigator.of(context)
                                                          .canPop()) {
                                                        context.pop();
                                                      }
                                                      context.pushNamed(
                                                        TreinosForClienteCopyCopyCopyWidget
                                                            .routeName,
                                                        queryParameters: {
                                                          'cliente':
                                                              serializeParam(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            treinosForClienteCopyCopyUsersRecord.tipoDeGerenciamento,
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  font: GoogleFonts.plusJakartaSans(
                                                                                    fontWeight: FontWeight.normal,
                                                                                    fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'TREINOS_FOR_CLIENTE_COPY_COPY_Column_29u');
                                                                  if (Navigator.of(
                                                                          context)
                                                                      .canPop()) {
                                                                    context
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            InkWell(
                                                                              ...
                                                                              highlightColor: Colors.transparent,
                                                                              onTap: () async {
                                                                                logFirebaseEvent('TREINOS_FOR_CLIENTE_COPY_COPY_Container_');
                                                                                await showModalBottomSheet(
                                                                                  isScrollControlled: true,
                                                                                  backgroundColor: Colors.transparent,
                                                                                  enableDrag: false,
