                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onChanged:
                                                                              (newValue) async {
                                                                            safeSetState(() =>
                                                                                _model.checkboxListTileValueMap4[treinoisItem] = newValue!);
                                                                            if (newValue!) {
                                                                ...
                                                                queryBuilder:
                                                                    (treinorsRecord) =>
                                                                        treinorsRecord
                                                                            .where(
                                                                              'treinosNoLIst',
                                                                              isEqualTo: FFAppState().filtroAdmin,
                                                                            )
                                                                            .where(
                                                                              'videoUrl',
                                                                              isEqualTo: null,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onChanged:
                                                                              (newValue) async {
                                                                            safeSetState(() =>
                                                                                _model.checkboxListTileValueMap5[columnTreinorsRecord] = newValue!);
                                                                            if (newValue!) {
                                                                              logFirebaseEvent('CREATE_ROTINA_DE_TREINO_COPY_CheckboxLis');
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onChanged:
                                                                              (newValue) async {
                                                                            safeSetState(() =>
                                                                                _model.checkboxListTileValueMap6[columnTreinorsRecord] = newValue!);
                                                                            if (newValue!) {
                                                                              logFirebaseEvent('CREATE_ROTINA_DE_TREINO_COPY_CheckboxLis');
                                                                              _model.addToTreinosSelecionados(columnTreinorsRecord.treinosNoLIst);
                                                                              safeSetState(() {});
