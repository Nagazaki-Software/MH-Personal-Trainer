import '/components/editarseriesrepnew_widget.dart';
              ...
              children: [
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent('CARD_ACOES_COPY2_COMP_Card_11_ON_TAP');
                    ...
                    onTap: () async {
                      ...
                      await showModalBottomSheet(
                        ...
                        builder: (context) {
                          return Padding(
                            padding: MediaQuery.viewInsetsOf(context),
                            child: EditarseriesrepnewWidget(
                              user: widget.cliente!,
