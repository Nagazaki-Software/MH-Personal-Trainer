                                ...
                                onPressed: () async {
                                  ...
                                  await AvaliacaoPosturalRecord.createDoc(
                                    ...
                                    dateForAvaliacaoPostural:
                                        getCurrentTimestamp,
                                    fotoFrontal: _model.uploadedFileUrl1,
                                    obsFotoFrontal: _model.textController1.text,
                                    fotoLateral: _model.uploadedFileUrl2,
                                    obsFotoLateral: _model.textController2.text,
                                    fotoPosterior: _model.uploadedFileUrl3,
                                    obsFotoPosterior:
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        await AvaliacaoPosturalRecord.createDoc(
                                          ...
                                          dateForAvaliacaoPostural:
                                              getCurrentTimestamp,
                                          fotoFrontal: _model.uploadedFileUrl4,
                                          obsFotoFrontal:
                                              _model.textController4.text,
                                          fotoLateral: _model.uploadedFileUrl5,
                                          obsFotoLateral:
