...
class FFAppState extends ChangeNotifier {
  ...
  Stream<List<CreateTreinosRecord>> cachePersonalsetreinois({
    ...
    bool? overrideCache,
    required Stream<List<CreateTreinosRecord>> Function() requestFn,
  }) =>
      _cachePersonalsetreinoisManager.performRequest(
        uniqueQueryKey: uniqueQueryKey,
        overrideCache: overrideCache,
        requestFn: requestFn,
      );
  void clearCachePersonalsetreinoisCache() =>
  ...
  Stream<List<SeriesRepeticoesRecord>> cache({
    String? uniqueQueryKey,
    bool? overrideCache,
    required Stream<List<SeriesRepeticoesRecord>> Function() requestFn,
  }) =>
      _cacheManager.performRequest(
        uniqueQueryKey: uniqueQueryKey,
        overrideCache: overrideCache,
        requestFn: requestFn,
      );
  void clearCacheCache() => _cacheManager.clear();
  void clearCacheCacheKey(String? uniqueKey) =>
      _cacheManager.clearRequest(uniqueKey);
