...
const kStripeTestSecretKey =
  "sk_test_51R56vx00hfXDRSJ7xqSje1sHng267PEtyyokNJJVUTNAeoHI1ZliM1Sa4CkxEG16m0xAUwb7SwSYsfdoN0MnAKFv00fIsY9Drt";
...
const kTokenId = "51089981-0ef8-4c8f-94eb-d67051ef2836";
const kTokenSecret =
  "fL0XgTQx1fCZb9YIZ5OTCw7yqQjDO6QsLBF7oIzUYYXnVOCdgDm3l7D+bLq9QOxC+nBqLUcS9Py";
...
const kUserKey =
  "os_v2_org_xx2cdjnjhve4rk3niiatik2aj6hfugioyktuajvbxkadmxn3jsge3sj7tysj3qxpdexomk5sbrv4vqs4rpa4sytnq2j4p2vacfbw62a";
const kAPIKey =
  "os_v2_app_wdkwya5fbvfs5h6xr7gx3rrcau7mzeo2px3ezffgpf6waxqv4zktlwhrga5334tuif2bog4fjq4lgtp5am6whyh3fqycfohdx5yprmy";
  ...
  .https.onCall(async (data, context) => {
    ...
    try {
      ...
      const createdUser = await client.createUser(
        "b0d56c03-a50d-4b2e-9fd7-8fcd7dc62205",
        user,
      );
...
exports.deleteUser = functions
  ...
  .https.onCall(async (data, context) => {
    ...
    const url = `https://api.onesignal.com/apps/b0d56c03-a50d-4b2e-9fd7-8fcd7dc62205/users/by/external_id/${data.user_id}`;
